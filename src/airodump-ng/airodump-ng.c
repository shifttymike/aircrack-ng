...
static int abg_chans[]
	= {1,   6,   11,  14,  2,   7,   3,   8,   4,   9,   5,   10,  12,
	   13,  36,  40,  44,  48,  52,  56,  60,  64,  100, 104, 108, 112,
	   116, 120, 124, 128, 132, 136, 140, 144, 149, 153, 157, 161, 165,
	   169, 173, 0};
static int bg_chans[] = {1, 6, 11, 14, 2, 7, 3, 8, 4, 9, 5, 10, 12, 13, 0};
static const int bg_chans_base[] = {1, 6, 11, 14, 2, 7, 3, 8, 4, 9, 5, 10, 12, 13, 0};
